...
qText = visual.TextStim(win=win, text='',pos=(0, 0.12), height=0.05, wrapWidth=1.4, color='white');
...
for thisVidTrial in VidTrials:
    ...
    if randCue == 1:
        ...
        print("randCue =1, roleCue = ", roleCueText)
    elif randCue == 2:
        roleCueText = "friend of the accused"
        print("randCue =2, roleCue = ", roleCueText)
    else:
        roleCueText = "friend of the victim"
        print("randCue =3, roleCue = ", roleCueText)
