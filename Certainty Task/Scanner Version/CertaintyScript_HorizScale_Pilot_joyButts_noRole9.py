...
#    thisExp.addData("y coord list", yArray)
    ...
    continueRoutine = True
    _enter_allKeys = []
    trialComponents = [joy, tick1, tick3, tick5, horLine, RoleQ, friendAcc, Det, friendVic, qInst]
