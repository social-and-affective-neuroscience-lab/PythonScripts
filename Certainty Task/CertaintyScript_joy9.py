...
#stimuli = csv.reader(open("Stimuli1.csv", encoding="cp437", sep=",", errors='ignore'))
#stimuli = pd.read_csv("Stimuli1.csv", sep='delimiter')
...
innHundred = visual.TextStim(win=win, text='', pos=(0.666, 0.30), height=0.029, color='white');
guiltyHundred = visual.TextStim(win=win, text='100%', pos=(0.659, -0.29), height=0.029, color='white');
innFifty = visual.TextStim(win=win, text='50%', pos=(0.66, 0.146), height=0.029, color='white');
zero=visual.TextStim(win=win, text="0%", pos=(0.66,0), height=0.029, color="white");
guiltyFifty = visual.TextStim(win=win, text='50%', pos=(0.66, -0.143), height=0.029, color='white');
...
qText = visual.TextStim(win=win, text='',pos=(0, 0.12), height=0.05, wrapWidth=1.3, color='white');
