...
#    timeVar = random.choice(jitterArray)
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        if text.status == STARTED:
            if tThisFlipGlobal > text.tStartRefresh + 2.000-frameTolerance:
                text.tStop = t
...
def itiFunc():
    ...
    thisExp.addData('iti Offset', itiOffsetTime)
...
def cueScreenFunc(bucketCue):
    ...
    thisExp.addData('Cuetext.stopped', cuetext.tStopRefresh)
...
#                continueRoutine = False
    ...
    thisExp.addData('All Stimuli Offset', offsetTime)
    routineTimer.reset()
...
#        thisExp.nextEntry()
    ...
    for thisTrial_4 in trials_4:
        ...
        if thisTrial_4 != None:
            for paramName in thisTrial_4:
                exec('{} = thisTrial_[paramName]'.format(paramName))
