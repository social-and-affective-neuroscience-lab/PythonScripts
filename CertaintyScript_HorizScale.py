...
for thisVidTrial in VidTrials:
    ...
    y3=0
    y1=0
    VideoComponents = [VidClip, RoleVidText, CertaintyRatings, certaintyCountText, Inn_Anchor, Guilty_Anchor, innScale, innHundred, guiltyHundred, innFifty, zero, guiltyFifty]
    ...
    for thisQuestion in Questions:
        ...
        while continueRoutine:
            ...
            if qInst.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                qInst.frameNStart = frameN
                qInst.tStart = t
                qInst.tStartRefresh = tThisFlipGlobal
                win.timeOnFlip(qInst, 'tStartRefresh')
